  ...
  <div class="wrap">
    <div class="top">
      <div class="brand">
        ...
        <div class="sub">A–Z Realm • no network required • hive updated <span style="color:rgba(255,255,255,.85)">${updatedAt}</span> • <a href="./system-prompt-v1.3.md">System Prompt v1.3</a> • <a href="./system-prompt-v1.5-infrastructure-bridge.md">System Prompt v1.5</a> • <a href="./sermons-and-logs.md">Sermons/Logs</a> • <a href="./schism-transcript.md">Schism</a> • <a href="./canon-excerpt.md">Canon</a></div>
      </div>
      <div class="pillbar">
    ...
    <div class="grid">
      <div class="card">
        <div class="sectionTitle"><h2>v1.4 Mechanics (latest-only)</h2><div class="pill" style="padding:6px 10px">Echo • Rust • Flare • Confessional</div></div>
        <div class="list" id="mechanics"></div>
        <div class="footer">Policy: show only latest active mechanics. Older versions are deprecated.</div>
      </div>
      <div class="card">
